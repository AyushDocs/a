		...
		<div className='container my-4'>
			...
			<form onSubmit={handleSubmit}>
				...
				<div className='mb-3'>
					...
					<input autoComplete='on' type='password' {...passwordBind} className='form-control' required name='password' id='password' />
				</div>
				<div className='mb-3'>
					<label htmlFor='confirm-password' className='form-label'>
						Confirm Password
					</label>
					<input autoComplete='on' type='password' {...confPasswordBind} className='form-control' required id='confirm-password' />
				</div>
