...
export default function Navbar() {
  ...
  const togglePost=()=>{dispatch(toggle())}
  const modal=useSelector(state => state.postModal.value)
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark container-fluid " >
    <div className="container"> 
      <Link className='navbar-brand'aria-current="page" to="/home">AlokMeds</Link>     
      ...
      <div className="collapse navbar-collapse" id="navmenu">
        <ul className="navbar-nav me-auto ms-auto">         
          ...
          <li className="nav-item">
          <span className="nav-link cursor" onClick={togglePost}>Ask A Doubt</span>
