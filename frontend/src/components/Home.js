  ...
  return (
    <>
      <section className="bg-dark p-5  text-light text-center">
        <div className="container d-flex justify-content-between">
          <div>
            ...
            <p className="lead">
              Get all your doubts clear and also view my latest publications
            </p>
            <p>
              ...
              <Link to="/admin/" className="btn btn-secondary">Are you an administrator?</Link>
            </p>
          </div>
          <div>
      ...
      <div className="row flex-gap">
        <h1 className="d-flex text-center goog-font">
          View Latest Publications
        </h1>
        <div className="col-md-1 col-sm-3 d-flex align-items-center">
          ...
          <div className="card bg-light ">
            <div className="card-body text-center py-0">
              ...
              <p className="card-text text-dark">
                ...
                amet consectetur adipisicing. amet consectetur adipisicing elit.
                Modi, reprehenderit.
              </p>
              <div className="d-flex justify-content-between align-items-center">
                <div className="btn-group">
